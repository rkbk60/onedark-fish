...
function set_onedark_color -a name rgb index256
    ...
    if test -z "$name"
        ...
        switch $name
            ...
            case green;     set default_color 98c379 114 2
            case yellow;    set default_color d19a66 173 3
            case blue;      set default_color 61afef 39  4
            case magenta;   set default_color c678dd 170 5
            case cyan;      set default_color 56b6c2 38  6
